...
Note also that some browsers have been found to have problems in establishing a connection to the python kernel, and the use of Mozilla Firefox or Google Chrome is recommended. In addition, beware that the limited computational power available in-cloud will make the examples provided slow to run at particular points along the code. 
